...
actor AlgorithmGenerator {
  ...
  init() {
    ...
    let instructions = """
           ...
           10. NEVER include "# Output:" comments or any comments showing expected output. The code ends after the last print() statement and the complexity comment. Nothing else.
